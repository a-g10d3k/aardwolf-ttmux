...
source=('aardwolf-ttmux::git+https://github.com/a-g10d3k/aardwolf-ttmux.git'
        'aardwolf-ttmux.sh')
sha256sums=('SKIP'
...
package() {
  ...
  cp -r modules conf util bin setup.tin README.MD "$pkgdir/usr/share/aardwolf-ttmux/"
